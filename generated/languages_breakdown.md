...
## JavaScript — 30.52% (2,200,250 bytes)
...
## Python — 27.29% (1,967,661 bytes)

- **sophieqli/VNSN-Project**: 1,048,978 bytes (53.3%)
- **imvinlin/swarmTrading**: 234,926 bytes (11.9%)
- **UF-SASE-Web-Team/AI-Advisor**: 87,833 bytes (4.5%)
- **imvinlin/networks-exam-study**: 79,237 bytes (4.0%)
- **imvinlin/Gator-Advisor**: 62,000 bytes (3.2%)
- **sean293/playing-card-object-detection**: 50,963 bytes (2.6%)
- **imvinlin/playing-card-object-detection**: 48,820 bytes (2.5%)
- **imvinlin/ad-load-performance-testing**: 40,770 bytes (2.1%)
- **imvinlin/WikiSearch**: 39,554 bytes (2.0%)
- **imvinlin/playground**: 35,609 bytes (1.8%)
- **imvinlin/placeGPT**: 31,088 bytes (1.6%)
- **lazysince87/SASEPass**: 28,463 bytes (1.4%)
- **imvinlin/github-stats**: 24,055 bytes (1.2%)
- **imvinlin/robotVoice**: 21,763 bytes (1.1%)
- **imvinlin/gator-registr**: 18,800 bytes (1.0%)
- **usharma123/ResumeReader**: 17,578 bytes (0.9%)
- **imvinlin/aad-project-m2**: 16,455 bytes (0.8%)
...
## TypeScript — 13.35% (962,602 bytes)

- **UF-SASE-Web-Team/UF-SASEHacks-Website**: 316,501 bytes (32.9%)
- **imvinlin/UF-SASEHacks-Website**: 224,431 bytes (23.3%)
- **UF-SASE-Web-Team/AI-Advisor**: 95,023 bytes (9.9%)
- **imvinlin/vincentlin-info**: 64,107 bytes (6.7%)
- **UF-SASE-Web-Team/Task-Balance-App**: 58,727 bytes (6.1%)
- **imvinlin/Gator-Advisor**: 47,442 bytes (4.9%)
- **imvinlin/imvinlin.github.io**: 46,814 bytes (4.9%)
- **sanjaytaylor2012/ShellHacks_Frontend**: 44,830 bytes (4.7%)
